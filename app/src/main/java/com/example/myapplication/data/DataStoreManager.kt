...
class DataStoreManager(private val context: Context){
    ...
    private val NOTES_KEY = stringPreferencesKey("notas")

    //guardar a los usuarios registrados
    suspend fun saveUsers(users: List<Usuario>){
        val json = gson.toJson(users)
        context.dataStore.edit { prefs ->
            prefs[USERS_KEY] = json //guardando el usuario, contiene los atributos del usuario
        }
    }
    ...
    //guardar las notas del usuario registrado
